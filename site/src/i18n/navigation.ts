      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: t('nav.connect'), href: lp('/start/60min/connect'), indent: 2 },
            { label: t('nav.deploy.item'), href: lp('/start/60min/deploy'), indent: 2 },
            { label: t('nav.complete'), href: lp('/start/60min/complete'), indent: 2 },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: 'SPA Routing', href: lp('/map/spa-routing'), indent: 2 },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'CORS Basics', href: lp('/map/cors-basics'), indent: 1 },
